      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 mb-8 text-sm">
          ...
          <ul className="space-y-2">
            ...
            <li><a href="/cookie-preferences" className="hover:underline">Cookie Preferences</a></li>
            <li><a href="/legal-notices" className="hover:underline">Legal Notices</a></li>
          </ul>
          <ul className="space-y-2">
            ...
            <li><a href="/corporate-info" className="hover:underline">Corporate Information</a></li>
